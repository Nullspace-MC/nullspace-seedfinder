...
#define DEFAULT_OUT_LIST "./seeds/th_bases.txt"
...
/* Searches a list of 48 bit base seeds for additional triple huts in the
 * given range around (0,0) and outputs the seeds translated such that
 * the triple huts are at (0,0)
 */
